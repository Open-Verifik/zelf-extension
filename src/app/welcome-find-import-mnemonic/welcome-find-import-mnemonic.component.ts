...
@Component({
    ...
    selector: "welcome-find-import-mnemonic",
    styleUrls: ["./welcome-find-import-mnemonic.component.scss"],
    templateUrl: "./welcome-find-import-mnemonic.component.html",
})
export class WelcomeFindImportMnemonicComponent implements OnInit {
    errorMessage: string = "";
    errorTitle: string = "";
    ...
    setMnemonics(): void {
        ...
        this._router.navigate(["/welcome/find-import-claim"]);
    }
