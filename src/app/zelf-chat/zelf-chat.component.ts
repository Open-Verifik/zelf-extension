        ...
        <div class="zelf-card home-hub" *transloco="let t">
            ...
            <div class="home-hub__body">
                <div class="chat-coming-soon">
                    <div class="chat-coming-soon__icon">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" fill="currentColor"/>
                        </svg>
                    </div>
                    <h2 class="chat-coming-soon__heading">{{ t("common.coming_soon") }}</h2>
                    <p class="chat-coming-soon__description">{{ t("common.zelf_chat_coming_soon") }}</p>
                </div>
            </div>
...
export class ZelfChatComponent implements OnInit, OnDestroy {
